...
screen quick_menu():
    ...
    if quick_menu:
        ...
        hbox:
            ...
            textbutton _("playtest") action Show('playtest') ## code red! comment out at launch as this is for playtest
...
screen playtest:
    ...
    grid 2 15:
        ...
        text "learned some cute Svet fact? [svet_fact]"

        text "french skill: [french]"
        text "hockey skill: [hockey]"

        text "seen which rooms with Svet today? [tourdone]"
